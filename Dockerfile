...
# docker build -t chat_gpt_clone_rails .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name chat_gpt_clone_rails chat_gpt_clone_rails
